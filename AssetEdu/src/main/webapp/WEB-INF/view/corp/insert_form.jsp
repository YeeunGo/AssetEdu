        ...
        <form:form action="/corp/insert" method="POST" modelAttribute="corp" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td><form:input type="text" class="form-control w-25" path="com01CorpCd" data-v-max-length="5" data-v-min-length="5" data-v-message="5글자여야 합니다."  /></td>
                </tr>
                <tr class="align-middle">
                    <td class="text-end">기관한글명</td>
                    <td><form:input type="text" class="form-control" path="com01CorpNm" data-v-max-length="100" /></td>
                </tr>
                <tr class="align-middle">
