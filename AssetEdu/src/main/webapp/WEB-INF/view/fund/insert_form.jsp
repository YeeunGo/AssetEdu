        ...
        <form:form action="/fund/insert" method="POST" modelAttribute="fund" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td class="w-25"><form:input type="text" class="form-control" path="fnd01FundCd" data-v-max-length="4" data-v-min-length="4" required="true" placeholder="필수입력(4자리)"/></td>
...
$(document).ready(function () {
	...
	$('#btnPopupFund').on('click', function(){
		//id 명만 주는 거임 (발행기관 코드/발행기관 이름)
		var url = '/popup/fund?fundCd=fnd01ParentFundCd&fundNm=fnd01ParentFundCdNm&whatType=mofund';
		var prop = {};
        var width = 720;
        var height = 518;
        var win = AssetUtil.popupWindow(url, '사무수탁사선택', {}, width, height);
