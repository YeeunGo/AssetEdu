...
<main class="container mx-3 my-3">
	...
	<div class="border-top border-2 p-4">
		...
		<form:form action="/admin/user/update" method="POST" modelAttribute="user" class="validcheck" >
		  ...
		  <div class="mb-3">
		    <form:label for="sys01tel" class="form-label"  path="sys01tel">사용자 전화번호</form:label>
		    <form:input type="text" class="form-control" path="sys01tel" placeholder="사용자명 입력" required="true" />
		  </div>
		  		  <div class="mb-3">
		    <form:label for="sys01email" class="form-label"  path="sys01email">사용자 email</form:label>
		    <form:input type="text" class="form-control" path="sys01email" placeholder="사용자명 입력" required="true" />
		  </div>
		  <div class="mb-3">
