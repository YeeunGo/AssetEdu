...
<main class="container mx-3 my-3">
	  ...
	  <tbody class="table-group-divider">
	  	<c:forEach var="user" items="${list}" varStatus="status">
		    <tr class="align-middle">
		      ...
		      <td>
			      <button class="btn btn-warning btn-sm btnModify" data-user-id="${user.sys01UserId }"><span><i class="fa-regular fa-pen-to-square"></i></span> 수정</button>
	...
	<form id="form1" action="/admin/user/list"  method="GET">
...
$(document).ready(function () {
	...
	$('.btnModify').on('click', function(){
		...
		AssetUtil.submitGet('/admin/user/modify', {sys01UserId: userId});
	})
