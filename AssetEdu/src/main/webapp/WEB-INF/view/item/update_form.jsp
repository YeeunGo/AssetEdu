...
<main class="container mx-3 my-3">
    ...
    <div class="border-top border-2 p-4">
        ...
        <form:form action="/item/update" method="POST" modelAttribute="item" class="validcheck" >
         <input type="hidden" name="originCd" value="${itm01ItemCd}}">
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    <td class="text-end" style="width:150px">종목코드/단축코드</td>
                    <td style="width:250px"><form:input type="text" class="form-control" path="itm01ItemCd" data-v-max-length="12" data-v-min-length="12" readonly="true"/></td>
...
$(document).ready(function () {
	...
	$('#btnPopupCorp').on('click', function(){
		...
		var url = '/popup/corp?corpCd=itm01IssCoCd&corpNm=itm01IssCoNm&whichPage=item';
		var prop = {};
        var width = 720;
        var height = 518;
