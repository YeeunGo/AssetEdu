        ...
        <form:form action="/item/insert" method="POST" modelAttribute="item" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td style="width:250px"><form:input type="text" class="form-control" path="itm01ItemCd" data-v-max-length="12" data-v-min-length="12" required="true" placeholder="종목코드 필수입력(12자리)"/></td>
                    <td style="width:150px"><form:input type="text" class="form-control" path="itm01ShortCd" placeholder="단축코드 입력"/></td>
                    <td></td>
                </tr>
                <tr class="align-middle">
                    <td class="text-end">종목한글명</td>
                    <td colspan=3><form:input type="text" class="form-control" path="itm01ItemNm" required="true" placeholder="필수입력"/></td>
                </tr>
                <tr class="align-middle">
                    <td class="text-end">종목영문명</td>
                    <td colspan=3><form:input type="text" class="form-control" path="itm01ItemEnm" placeholder="입력"/></td>
                </tr>
                <tr class="align-middle">
                    <td class="text-end">상장구분</td>
                    <td>
                           <form:select path="itm01ListType" class="form-select" id="selectListType" data-required="true">
     					   <form:option value="" />
       						 <form:options items="${stkListTypeList}" itemValue="com02DtlCd" itemLabel="com02CodeNm" placeholder="선택"/> 
   							 </form:select>
   							 <span class="validation-error" style="display:none; color:red;">필수 입력란입니다</span>
</td>
                    <td colspan=2></td>
                </tr>
                <tr class="align-middle">
                    ...
                    <td>
                        <form:select path="itm01MarketType" class="form-select" data-required="true">
                            <form:option value=""/>
...
$(document).ready(function () {
	...
	$('#btnPopupCorp').on('click', function(){
		...
		var url = '/popup/corp?corpCd=itm01IssCoCd&corpNm=itm01IssCoNm&whichPage=common';
		var prop = {};
        var width = 720;
        var height = 518;
