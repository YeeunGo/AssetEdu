...
$(document).ready(function () {
	...
	$('#btnPopupJnl14ReprAcntCd').on('click', function(){
        var url = '/popup/jnl/repr-acnt?reprAcntCdId=jnl14ReprAcntCd&reprAcntNmId=jnl14ReprAcntNm';
        var prop = {};
        var width = 720;
        var height = 518;
	...
	$('#btnPopupJnl14RealAcntCd').on('click', function(){
        var url = '/popup/jnl/acnt/child?acntCd=jnl14RealAcntCd&acntNm=jnl14RealAcntNm&slipYn=T';
        var prop = {};
        var width = 720;
        var height = 518;
