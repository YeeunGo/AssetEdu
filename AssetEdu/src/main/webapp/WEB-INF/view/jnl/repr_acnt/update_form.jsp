...
<main class="container mx-3 my-3">
	...
	<h2><i class="fa-solid fa-cube my-3"></i> 대표계정코드 관리 > 대표계정코드 상세/수정</h2>
    <div class="border-top border-2 p-4">

        <form:form action="/jnl/repr_acnt/update" method="POST" modelAttribute="jnl11ReprAcnt" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    <td class="text-end" style="width:150px">대표계정코드</td>
                    <td style="width:250px"><form:input type="text" class="form-control" path="jnl11ReprAcntCd" readonly="true"/></td>
                    <td></td>
                    <td></td>
                </tr>
                <tr class="align-middle">
