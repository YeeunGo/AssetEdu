...
<main class="container mx-3 my-3">
	...
	<h2><i class="fa-solid fa-cube my-3"></i> 계정과목 관리 > 계정과목 상세/수정</h2>
        ...
        <form:form action="/jnl/acnt/update" method="POST" modelAttribute="jnl10Acnt" class="validcheck" >
            <table class="table table-sm table-borderless">
                <tr class="align-middle">
                    ...
                    <td style="width:250px"><form:input type="text" class="form-control" path="jnl10AcntCd" readonly="true"/></td>
                    <td></td>
                    <td></td>
                </tr>
                <tr class="align-middle">
...
$(document).ready(function () {
    ...
    var Jnl10SlipYn = "${jnl10SlipYn}"; 
    var Jnl10UseYn = "${jnl10UseYn}"; 

    // 전표생성여부 체크
    if (Jnl10SlipYn === "true") {
        document.getElementById("jnl10SlipYn11").checked = true;
    } else {
        document.getElementById("jnl10SlipYn22").checked = true;
    }

    // 사용여부 체크
    if (Jnl10UseYn === "true") {
        document.getElementById("jnl10UseYn11").checked = true;
    } else {
        document.getElementById("jnl10UseYn22").checked = true;
    }
